...
| GPIO3 | 输出 | EAI S2 激光雷达 DATA/RX | ESP32 TX -> 雷达 DATA | 反接测试线序；固件上电/重启串口后发送 `A5 60` 启动 |
...
| GPIO43 | 输入 | EAI S2 激光雷达 CTL/TX | 雷达 CTL -> GPIO43 | 反接测试线序；UART2 RX，默认 150000 8N1 |
...
| LIDAR-03 | EAI S2 激光雷达 | DATA/RX | ESP32 | GPIO3 | 3.3V 串口电平 | 反接测试：ESP32 TX -> 雷达 DATA/RX |
| LIDAR-04 | EAI S2 激光雷达 | CTL/TX | ESP32 | GPIO43 | 3.3V 串口电平 | 反接测试：雷达 CTL/TX -> ESP32 RX |
