...
- 主控：ESP32-S3-DevKitC-1-N32R16V / ESP32-S3-WROOM-2-N32R16V，32 MB Octal Flash + 16 MB Octal PSRAM，OPI/1.8 V，负责遥控输入、传感器、安全状态机和油门输出。
...
1. ESP32-S3-DevKitC-1-N32R16V / ESP32-S3-WROOM-2-N32R16V 禁止把 GPIO35/36/37/47/48 作为电机驱动输出；旧引脚方案作废。
